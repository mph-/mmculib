...
i2c_ret_t
i2c_master_addr_write (i2c_t dev, i2c_id_t slave, i2c_t addr,
                       uint8_t addr_size, void *buffer, uint8_t size);


/** Write data from slave.  No internal address is sent.  */
i2c_ret_t
i2c_master_write (i2c_t i2c, uint8_t addr_size, void *buffer, uint8_t size);


i2c_ret_t
i2c_master_addr_read (i2c_t dev, i2c_id_t slave, i2c_t addr,
                      uint8_t addr_size, void *buffer, uint8_t size);

/** Read data from slave.  No internal address is sent.  */
i2c_ret_t
i2c_master_read (i2c_t i2c, i2c_id_t slave, void *buffer, uint8_t size);
